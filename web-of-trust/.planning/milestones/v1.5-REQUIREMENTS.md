# Requirements Archive: v1.5 Dgraph Follow-Update Timeout Resilience

**Archived:** 2026-06-18
**Status:** SHIPPED

Current milestone requirements are intentionally absent until the next milestone is opened with `$gsd-new-milestone`.
